...
To be a Rack enabled application, the class needs to contain a method called: call. And the method needs to return
an array containing 3 elements. It's pretty basic: [status_code, headers, body]. 
